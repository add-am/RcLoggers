...
Should `SmallTables = TRUE` it is reccomended that files are saved within broader folders based on logger and year using the following code (again where .x = data_extract, and .y = the names of items in the list):
